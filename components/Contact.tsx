    ...
    <footer id="contact" className="bg-slate-950 relative pt-20 md:pt-32 pb-12 border-t border-slate-900">
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-4xl md:text-7xl font-serif text-white mb-6">{t.title}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-24">
          ...
          <div className="md:col-span-4 space-y-8 md:pt-8 order-2 md:order-1">
            ...
            <div>
              ...
              <a href="mailto:navonifederico777@gmail.com" className="text-slate-300 text-sm hover:text-indigo-400 transition-colors block mb-2">
                navonifederico777@gmail.com
              </a>
              <span className="text-slate-300 text-sm block">+39 3270934054</span>
            </div>
            <div>
          ...
          <div className="md:col-span-8 bg-slate-900/20 p-6 md:p-12 rounded-sm border border-slate-800 order-1 md:order-2">
            <form className="space-y-6 md:space-y-8" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div className="group">
                  <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2 group-focus-within:text-indigo-400 transition-colors">{t.formName}</label>
                ...
                <div className="group">
                  <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2 group-focus-within:text-indigo-400 transition-colors">{t.formDate}</label>
                  <input type="text" className="w-full bg-transparent border-b border-slate-700 py-3 text-slate-200 focus:border-indigo-500 outline-none transition-colors rounded-none" />
                </div>
              </div>
              <div className="group">
                <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2 group-focus-within:text-indigo-400 transition-colors">{t.formEmail}</label>
              ...
              <div className="group">
                <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2 group-focus-within:text-indigo-400 transition-colors">{t.formDetails}</label>
